...
} opusarium_cache_align opusarium_thread_conf_t;
...
typedef struct {
    ...
    void *thread_arg;
    int thread_ret;
} opusarium_cache_align opusarium_thread_executor_t;
...
typedef struct {
    ...
    size_t stack_size;
    void *stack_ptr;
} opusarium_cache_align opusatrium_thread_t;
